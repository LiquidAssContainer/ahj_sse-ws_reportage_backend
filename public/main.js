...
var TO_STRING_TAG_SUPPORT = __webpack_require__(16);
var redefine = __webpack_require__(13);
...
var es_object_to_string = __webpack_require__(56);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.regexp.to-string.js
var es_regexp_to_string = __webpack_require__(59);

// CONCATENATED MODULE: ./src/js/ReportageWidget.js
...
var ReportageWidget = /*#__PURE__*/function () {
  function ReportageWidget(url) {
    _classCallCheck(this, ReportageWidget);

    this.url = url;
    this.eventsContainer = document.getElementById('events');
  }

  _createClass(ReportageWidget, [{
    key: "init",
    value: function init() {
      var _this = this;

      var eventSource = new EventSource(this.url);
      var eventTypes = ['start', 'action', 'freekick', 'goal'];

      for (var _i = 0, _eventTypes = eventTypes; _i < _eventTypes.length; _i++) {
        var event = _eventTypes[_i];
    ...
    key: "renderNewEvent",
    value: function renderNewEvent(event) {
    ...
    value: function getFormattedDate(date) {
      ...
      var DMY = "".concat(day, ".").concat(month, ".").concat(year);
      ...
      return "".concat(time, " ").concat(DMY);
    }
  }]);

  return ReportageWidget;
}();
